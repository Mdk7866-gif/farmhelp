...
const indiaServiceCenters = [
  { id: 1, name: "Amaravati Krishi Seva", address: "Amaravati, Andhra Pradesh 522002", phone: "+91 863 223 4455", timing: "9:00 AM - 6:00 PM", image: "https://images.unsplash.com/photo-1590684153400-e3e759754475?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Amaravati+Andhra+Pradesh" },
  { id: 2, name: "Tawang Agri-Support", address: "Tawang, Arunachal Pradesh 790104", phone: "+91 3794 222 111", timing: "8:30 AM - 5:00 PM", image: "https://images.unsplash.com/photo-1582234372722-50d7ccc30eb3?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Tawang+Arunachal+Pradesh" },
  { id: 3, name: "Brahmaputra Farmer Hub", address: "Guwahati, Assam 781005", phone: "+91 361 245 6789", timing: "9:00 AM - 7:00 PM", image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Guwahati+Assam" },
  { id: 4, name: "Pataliputra Kisan Kendra", address: "Patna, Bihar 800001", phone: "+91 612 222 3344", timing: "10:00 AM - 6:00 PM", image: "https://images.unsplash.com/photo-1590013330462-0761667d415f?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Patna+Bihar" },
  { id: 5, name: "Raipur Agrotech", address: "Raipur, Chhattisgarh 492001", phone: "+91 771 405 6000", timing: "9:30 AM - 6:30 PM", image: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Raipur+Chhattisgarh" },
  ...
  { id: 8, name: "Karnal Farm Connect", address: "Karnal, Haryana 132001", phone: "+91 184 226 7788", timing: "8:00 AM - 6:00 PM", image: "https://images.unsplash.com/photo-1523348830342-d0187cf0c28d?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Karnal+Haryana" },
  ...
  { id: 19, name: "Utkal Krishi Kendra", address: "Bhubaneswar, Odisha 751001", phone: "+91 674 253 4455", timing: "10:00 AM - 6:00 PM", image: "https://images.unsplash.com/photo-1523348830342-d0187cf0c28d?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Bhubaneswar+Odisha" },
  ...
  { id: 23, name: "Chennai Kaveri Center", address: "Chennai, Tamil Nadu 600002", phone: "+91 44 2852 4455", timing: "9:00 AM - 8:00 PM", image: "https://images.unsplash.com/photo-1516000526235-b31e7cff3f2f?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Chennai+Tamil+Nadu" },
  ...
  { id: 25, name: "Agartala Rubber Hub", address: "Agartala, Tripura 799001", phone: "+91 381 232 4455", timing: "9:00 AM - 6:00 PM", image: "https://images.unsplash.com/photo-1582234372722-50d7ccc30eb3?auto=format&fit=crop&w=400&q=60", googleMapsLink: "https://www.google.com/maps/search/Agartala+Tripura" },
