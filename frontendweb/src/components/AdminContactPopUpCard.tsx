...
interface AdminContactPopUpCardProps {
...
export default function AdminContactPopUpCard({
    message,
    onClose,
    onDelete,
    isDeleting = false
}: AdminContactPopUpCardProps) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden animate-in zoom-in-95 duration-200 border border-gray-200 dark:border-gray-800">
                ...
                <div className="relative h-24 bg-gradient-to-r from-amber-500 to-orange-600">
                    <button
                        onClick={onClose}
                    ...
                    <div className="absolute -bottom-10 left-8">
                        <div className="w-20 h-20 bg-white dark:bg-gray-900 rounded-2xl p-2 shadow-xl border-4 border-white dark:border-gray-900">
                            <div className="w-full h-full bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center text-amber-600 dark:text-amber-400">
                    ...
                    <div>
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <span className="inline-flex items-center gap-1.5 mt-2 px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-xs font-bold uppercase tracking-wider rounded-full">
